...
template proveCredentialOwnership(IdOwnershipLevels, IssuerLevels) {
	...
	signal input isProofValidNotRevMtpAux;
	...
	// DEBUG BEGIN
	// claimRevNonce.revNonce === 1
	// revNonceHiHv.hi === 2279272124503809695177170942549831206840003426178943720957919922723804431629;
	// revNonceHiHv.hv === 17142353815121200339963760108352696118925531835836661574604762966243856573359;
	// DEBUG END
	...
	smtClaimValid.isOld0 <== isProofValidNotRevMtpAux;
