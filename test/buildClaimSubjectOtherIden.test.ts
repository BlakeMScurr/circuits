...
describe("buildClaimSubjectOtherIden test", function () {
    this.timeout(200000);

    it("Test BuildClaimSubjectOtherIden", async () => {
        const circuit = await tester(
            path.join(__dirname, "circuits", "buildClaimSubjectOtherIden.circom"),
